...
#define __SYSTEM_CLOCK_32M      (32000000UL)


#if defined ( __CC_ARM )
    uint32_t SystemCoreClock __attribute__((used)) = __SYSTEM_CLOCK_32M;
#elif defined ( __ICCARM__ )
    __root uint32_t SystemCoreClock = __SYSTEM_CLOCK_32M;
...
{
    SystemCoreClock = __SYSTEM_CLOCK_32M;
}
